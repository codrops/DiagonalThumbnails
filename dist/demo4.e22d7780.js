...
exports.preloadFonts = exports.preloadImages = exports.getMousePos = exports.lerp = void 0;
...
},{"gsap":"TpQl","./utils":"MgTz"}],"oR66":[function(require,module,exports) {
...
var Slideshow = /*#__PURE__*/function () {
  function Slideshow(el) {
    ...
    _toConsumableArray(this.DOM.el.querySelectorAll('.slide')).forEach(function (slide) {
      return _this.slides.push(new _slide.default(slide));
  ...
  _createClass(Slideshow, [{
    ...
    value: function navigate(direction) {
      ...
      .to(currentSlide.DOM.imgs, {
        x: function x(pos) {
          return "".concat(_this3.positions.x[direction][pos], "%");
        },
        y: function y(pos) {
          return "".concat(_this3.positions.y[direction][pos], "%");
        },
        rotation: function rotation(pos) {
          return _this3.positions.rotation[direction][pos];
        },
        opacity: 0,
        stagger: direction === 'next' ? 0.06 : -0.06
      }, 'start').addLabel('upcoming', 0.4).add(function () {
      ...
      .to(nextSlide.DOM.imgs, {
        startAt: {
          x: function x(pos) {
            return "".concat(_this3.positions.x[_this3.reverseDirection(direction)][pos], "%");
          },
          y: function y(pos) {
            return "".concat(_this3.positions.y[_this3.reverseDirection(direction)][pos], "%");
          },
          rotation: function rotation(pos) {
            return _this3.positions.rotation[_this3.reverseDirection(direction)][pos];
          }
        },
        x: '0%',
        y: '0%',
    ...
    value: function reverseDirection(direction) {
...
},{"splitting/dist/splitting.css":"oR66","splitting/dist/splitting-cells.css":"yIBK","gsap":"TpQl","../slide":"Drnq"}],"ZH4r":[function(require,module,exports) {
"use strict";
...
},{"../utils":"MgTz","../cursor":"LMRJ","./slideshow":"WdSS"}]},{},["ZH4r"], null)